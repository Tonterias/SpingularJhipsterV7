...
export class UrllinkComponent implements OnInit {
  ...
  trackId(index: number, item: IUrllink): number {
    return item.id!;
  }

  delete(urllink: IUrllink): void {
    const modalRef = this.modalService.open(UrllinkDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: IUrllink[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
