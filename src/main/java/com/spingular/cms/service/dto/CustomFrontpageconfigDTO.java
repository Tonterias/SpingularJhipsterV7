...
public class CustomFrontpageconfigDTO implements Serializable {
    ...
    public String toString() {
        return (
            ...
            getRecentPosts4() +
            ", featuredArticles1=" +
            getFeaturedArticles1() +
            ", featuredArticles2=" +
            getFeaturedArticles2() +
            ", featuredArticles3=" +
            getFeaturedArticles3() +
            ", featuredArticles4=" +
            getFeaturedArticles4() +
            ", featuredArticles5=" +
            getFeaturedArticles5() +
            ", featuredArticles6=" +
            getFeaturedArticles6() +
            ", featuredArticles7=" +
            getFeaturedArticles7() +
            ", featuredArticles8=" +
            getFeaturedArticles8() +
            ", featuredArticles9=" +
            getFeaturedArticles9() +
            ", featuredArticles10=" +
            getFeaturedArticles10() +
            ", popularNews1=" +
            getPopularNews1() +
            ", popularNews2=" +
            getPopularNews2() +
